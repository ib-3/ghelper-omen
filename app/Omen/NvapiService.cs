...
#pragma warning restore CS0219
        ...
        /// <summary>
        /// Check if the GPU is currently powered/active.
        /// Returns false if the GPU is asleep or powered off.
        /// </summary>
        public bool IsGpuPowered()
        {
            if (!_initialized || _primaryGpu == null) return false;
            try
            {
                var state = GPUApi.GetCurrentPerformanceState(_primaryGpu.Handle);
                return true;
            }
            catch (Exception)
            {

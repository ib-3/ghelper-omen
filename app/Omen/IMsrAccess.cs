...
namespace OmenCore.Hardware
{
    ...
    public interface IMsrAccess : IDisposable
    {
        ...
        /// <summary>
        /// Read a raw MSR value.
        /// </summary>
        ulong ReadRawMsr(uint msr);
        ...
        /// <summary>
        /// Read IA32_HWP_REQUEST energy performance preference (0-255).
        /// </summary>
        int ReadHwpEpp();

        /// <summary>
        /// Set IA32_HWP_REQUEST energy performance preference (0-255) on all logical processors.
        /// </summary>
        bool SetHwpEpp(int epp);
        ...
        /// <summary>
        /// Read live CPU package power consumption in watts.
        /// </summary>
        double ReadCpuPackagePowerWatts();

        /// <summary>
        /// Read the CPU's maximum power capability from MSR 0x614 (MSR_PKG_POWER_INFO).
        /// Used to set the power limit slider maximum dynamically.
        /// </summary>
        int ReadMaxPowerWatts();
    }
}
